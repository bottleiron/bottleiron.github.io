...
사용자가 돈을 썼거나 돈이 들어왔다는 내용일 경우, 아래 구조로 데이터를 추출하세요 (금액은 양수 숫자). 월급, 용돈, 캐시백 등 들어온 돈이면 카테고리에 "수입"을 넣으세요. 나간 돈이면 카테고리는 식비, 교통비, 이자, 관리비, 통신비, 공과금, 보험, 문화생활, 모임, 쇼핑, 그리시유, 경조사비, 저축, 기타 중에서 가장 적합한 것을 고르세요.
