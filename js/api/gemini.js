export const geminiApi = {
    apiKey: null,
    apiUrl: "https://generativelanguage.googleapis.com/v1beta/models/gemini-3.0-flash-lite:generateContent",
...
`;
    ...
    async parseChatInput(userText, currentDateStr) {
        const CATEGORIES_LIST = "식비, 교통비, 이자, 관리비, 통신비, 공과금, 보험, 문화생활, 모임, 쇼핑, 그리시유, 경조사비, 저축, 기타";
